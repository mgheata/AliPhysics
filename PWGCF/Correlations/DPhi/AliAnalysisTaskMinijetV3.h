#ifndef AliAnalysisTaskMinijetV3_H
#define AliAnalysisTaskMinijetV3_H
...
class AliAnalysisTaskMinijetV3 : public AliAnalysisTaskSE {
 public:
  AliAnalysisTaskMinijetV3(const char *name="<default name>");
  virtual ~AliAnalysisTaskMinijetV3();
 ...
 private:
  ...
  AliAnalysisTaskMinijetV3(const AliAnalysisTaskMinijetV3&); // not implemented
  AliAnalysisTaskMinijetV3& operator=(const AliAnalysisTaskMinijetV3&); // not implemented
  
  ClassDef(AliAnalysisTaskMinijetV3, 2); // mini jet analysis with two particle correlations
};
