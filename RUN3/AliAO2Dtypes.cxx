...
Float_t Centrality_t::GetCentralityPercentile(const char *x) const
{
  if (fQuality == 0) {
    TString method = x;
...
Int_t Centrality_t::GetCentralityClass10(const char *x) const
{
...
Int_t Centrality_t::GetCentralityClass5(const char *x) const
{
// Return the centrality class
  if (fQuality == 0) {
    TString method = x;
...
Bool_t Centrality_t::IsEventInCentralityClass(Float_t a, Float_t b, const char *x) const
{
...
Float_t Centrality_t::GetCentralityPercentileUnchecked(const char *x) const
{
...
Int_t Centrality_t::GetCentralityClass10Unchecked(const char *x) const
{
// Return the centrality class
  TString method = x;
    if(method.CompareTo("V0M")==0)      return (Int_t) (fCentralityV0M / 10.0);
...
Int_t Centrality_t::GetCentralityClass5Unchecked(const char *x) const
{
// Return the centrality class
  TString method = x;
    if(method.CompareTo("V0M")==0)      return (Int_t) (fCentralityV0M / 5.0);
...
Bool_t Centrality_t::IsEventInCentralityClassUnchecked(Float_t a, Float_t b, const char *x) const
{
