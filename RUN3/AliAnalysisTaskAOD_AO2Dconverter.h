...
#ifndef AliAnalysisTaskAOD_AO2Dconverter_H
#define AliAnalysisTaskAOD_AO2Dconverter_H
...
class AliAnalysisTaskAOD_AO2Dconverter : public AliAnalysisTaskSE
{
public:
  AliAnalysisTaskAOD_AO2Dconverter() = default;
  AliAnalysisTaskAOD_AO2Dconverter(const char *name);
  virtual ~AliAnalysisTaskAOD_AO2Dconverter();

  AliAnalysisTaskAOD_AO2Dconverter(const AliAnalysisTaskAOD_AO2Dconverter &) = default;
  AliAnalysisTaskAOD_AO2Dconverter &operator=(const AliAnalysisTaskAOD_AO2Dconverter &) = delete;
  ...
  static AliAnalysisTaskAOD_AO2Dconverter* AddTask(TString suffix = "");
...
private:
  ...
  ClassDef(AliAnalysisTaskAOD_AO2Dconverter, 10);
};
