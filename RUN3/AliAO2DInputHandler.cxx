...
void AliAO2DInputHandler::ConnectEventTree(TTree *tree) const
{
  ...
  br = tree->GetBranch("fGlobalBC");
  br->SetAddress((void*)&fEvent.fGlobalBC);
  ...
  br = tree->GetBranch("fX_SPD");
  br->SetAddress((void*)&fEvent.fX_SPD);
  br = tree->GetBranch("fY_SPD");
  br->SetAddress((void*)&fEvent.fY_SPD);
  br = tree->GetBranch("fZ_SPD");
  br->SetAddress((void*)&fEvent.fZ_SPD);
  br = tree->GetBranch("fCovXX_SPD");
  br->SetAddress((void*)&fEvent.fCovXX_SPD);
  br = tree->GetBranch("fCovXY_SPD");
  br->SetAddress((void*)&fEvent.fCovXY_SPD);
  br = tree->GetBranch("fCovXZ_SPD");
  br->SetAddress((void*)&fEvent.fCovXZ_SPD);
  br = tree->GetBranch("fCovYY_SPD");
  br->SetAddress((void*)&fEvent.fCovYY_SPD);
  br = tree->GetBranch("fCovYZ_SPD");
  br->SetAddress((void*)&fEvent.fCovYZ_SPD);
  br = tree->GetBranch("fCovZZ_SPD");
  br->SetAddress((void*)&fEvent.fCovZZ_SPD);
  br = tree->GetBranch("fChi2_SPD");
  br->SetAddress((void*)&fEvent.fChi2_SPD);
  br = tree->GetBranch("fN_SPD");
  br->SetAddress((void*)&fEvent.fN_SPD);
  br = tree->GetBranch("fV0centr");
  br->SetAddress((void*)&fEvent.fV0centr);
  br = tree->GetBranch("fCollisionTime");
  br->SetAddress((void*)&fEvent.fCollisionTime);
  br = tree->GetBranch("fCollisionTimeRes");
  br->SetAddress((void*)&fEvent.fCollisionTimeRes);
  br = tree->GetBranch("fCollisionTimeMask");
  br->SetAddress((void*)&fEvent.fCollisionTimeMask);
}
...
void AliAO2DInputHandler::ConnectTracksTree(TTree *tree) const
{
  ...
  br = tree->GetBranch("fTPCnclsFindable");
  br->SetAddress((void*)&fReadTrack.fTPCnclsFindable);
  br = tree->GetBranch("fTPCnclsFindableMinusFound");
  br->SetAddress((void*)&fReadTrack.fTPCnclsFindableMinusFound);
  br = tree->GetBranch("fTPCnclsFindableMinusCrossedRows");
  br->SetAddress((void*)&fReadTrack.fTPCnclsFindableMinusCrossedRows);
  br = tree->GetBranch("fTPCnclsShared");
  br->SetAddress((void*)&fReadTrack.fTPCnclsShared);
